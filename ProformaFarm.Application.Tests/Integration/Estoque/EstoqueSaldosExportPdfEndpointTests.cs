...
public sealed class EstoqueSaldosExportPdfEndpointTests : IClassFixture<CustomWebApplicationFactory>
{
    private readonly CustomWebApplicationFactory _factory;

    public EstoqueSaldosExportPdfEndpointTests(CustomWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task Sem_token_deve_retornar_401()
    {
        ...
        var response = await client.GetAsync("/api/estoque/saldos/exportar-pdf");
    ...
    public async Task Com_token_deve_retornar_pdf_com_headers_padrao()
    {
        ...
        var response = await client.GetAsync($"/api/estoque/saldos/exportar-pdf?idOrganizacao={setup.IdOrganizacao}&idProduto={setup.IdProduto}&limite=100");
